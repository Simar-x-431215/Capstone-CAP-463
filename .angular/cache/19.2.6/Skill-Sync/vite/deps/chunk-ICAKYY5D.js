...
import {
  ...
  ɵfirebaseAppFactory,
  ɵlazySDKProxy
} from "./chunk-NWTAUNSU.js";
import {
  firebase
} from "./chunk-LTUKHXUD.js";
import {
  isPlatformServer
...
import {
  ...
  ɵɵdefineNgModule,
  ɵɵinject
} from "./chunk-32EEY6AT.js";
import {
  merge
} from "./chunk-IXECIEEC.js";
import {
  Observable,
  Subject,
  filter,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-KIHQBWCX.js"))), map(() => ɵfirebaseAppFactory(options, zone, name)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
...
//# sourceMappingURL=chunk-ICAKYY5D.js.map
